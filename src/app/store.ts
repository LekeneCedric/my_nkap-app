...
import OperationAIApiGatewayHttp from '../Infrastructure/Operation/Gateways/OperationAIApiGatewayHttp.ts';
        ...
        getDefaultMiddleware({
            ...
            thunk: {
                extraArgument: {
                    ...
                    operationAIApiGatewayHttp: new OperationAIApiGatewayHttp(),
                },
            },
