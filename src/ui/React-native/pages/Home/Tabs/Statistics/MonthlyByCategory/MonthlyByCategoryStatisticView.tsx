    ...
    return <View style={styles.container}>
        <View style={{alignItems: 'center'}}>
            ...
            <View style={[styles.tableRowContainer]}>
                <Text style={[styles.tableColTitle, {flex: 4, color: action1}]}>{translate('category')}</Text>
                {/*<Text style={[styles.tableColTitle, {flex: 1}]}>%</Text>*/}
                <Text style={[styles.tableColTitle, {flex: 2, textAlign: 'center', color: action1}]}>{translate('amount')}(XAF)</Text>
            </View>
        </View>
